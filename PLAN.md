...
- Post-soak status at the time of Batch 9 was 33 persisted routes / 9 configured providers, 8 effective providers, 21 probe-fresh healthy routes and 12 broken/hidden routes. **Superseded by CURRENT readback:** the broker still has 8 effective providers but now 12 probe-fresh healthy routes and 21 broken/hidden routes, with `requestsRouted=24`, `successCalls=24`, `errorCalls=0`, `inFlight=0`, `shuttingDown=false`. The changing probe pool is upstream-health drift, not a durable-set mutation.
