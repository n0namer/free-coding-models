...
11. **Next bounded move.** Execute Batch 6 only: produce a keep/adopt/drop convergence map against upstream 0.5.88 and identify the smallest exact-source testable delta. Do not mutate the working runtime unless that comparison proves a new CURRENT defect; no GitHub-first implementation and no redeploy debug loop.
